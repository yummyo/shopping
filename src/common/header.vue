          ...
          <div class="right-box">
            ...
            <div class="nav-aside" ref="aside" :class="{fixed:st}">
              <div class="user pr">
                ...
                <!--用户信息显示-->
                <div class="nav-user-wrapper pa" v-if="login || true">
                    ...
                    <ul>
                      ...
                      <li class="nav-user-avatar">
                        <div>
                          <span
                            class="avatar"
                            :style="{backgroundImage:'url('+(userInfo?userInfo.info.file:'')+')'}"
                          ></span>
                        </div>
                        <p class="name">{{userInfo?userInfo.info.username:''}}</p>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="nav-sub-wrapper" :class="{fixed:st}">
            <div class="w">
              <ul class="nav-list2">
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">首页</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">居家生活</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">服饰鞋包</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">美食酒水</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">个护清洁</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">母婴亲子</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">运动旅行</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">数码家电</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">全球特色</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">为你严选</a>
                  </router-link>
                </li>
                <li>
                  <router-link to="/">
                    <a @click="changePage(1)" :class="{active:choosePage===1}">众筹</a>
                  </router-link>
                </li>
              </ul>
              <div></div>
